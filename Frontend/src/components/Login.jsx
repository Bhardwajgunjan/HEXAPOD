...
function Login() {
  ...
  const onSubmit = (data) => {
    ...
    axios
      .post(`${import.meta.env.API_URL}/api/user/login`, userInfo)
      .then((response) => {
        if (response.data) {
          toast.success("Login successful");
        }
        localStorage.setItem("HexaPod", JSON.stringify(response.data));
      ...
      <div className="flex h-screen items-center justify-center">
        ...
        >
          <h1 className="text-2xl text-center">
            Hexa<span className="text-green-500 font-semibold">Pod</span>
          </h1>
